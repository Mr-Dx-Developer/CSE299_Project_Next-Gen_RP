...
CreateThread(function()
    exports['qb-target']:AddBoxZone("revivebed", vector3(322.27, -589.57, 43.99), 1.5, 1.5, {
        name = "revivebed",
        heading = 0,
        debugPoly = false,
        minZ = 42.0,
        ...
        options = { 
            {
                type = "client",
                event = "qb-ambulancejob:client:putonbed",
    ...
    exports['qb-target']:AddBoxZone("revivebag", vector3(323.35, -589.46, 44.25), 0.5, 0.5, {
        name = "revivebag",
        heading = 0,
        debugPoly = false,
        minZ = 42.0,
...
RegisterNetEvent("qb-ambulancejob:client:putonbed", function()
    local PlayerPed = PlayerPedId()
    SetEntityCoords(PlayerPed, vector4(322.27, -589.57, 43.99, 226.89))
    ...
    SetEntityHeading(PlayerPed, 226.89)
end)