...
Config.Locations = {
    ...
    stash = {
        vector3(-1074.18, -814.24, 15.64),
    },
    impound = {
        vector3(-1075.42, -804.92, 7.93),
    ...
    trash = {
        vector3(-1074.74, -816.73, 15.64),
    },
    fingerprint = {
        vector3(-1080.55, -826.74, 16.43),
    },
    evidence = {
        vector3(-1085.52, -835.18, 23.46),
        vector3(-1083.6, -833.58, 23.46),
        vector3(-1086.96, -833.54, 23.46),
    },
    stations = {
        { label = 'Police Station',        coords = vector4(-1088.82, -830.96, 37.68, 22.51) },
