...
## Dependencies ##
- [FM-FW](https://github.com/qbcore-framework/FM-FW)
...
Search "TriggerServerEvent('lb-phone:server:sendNewMail', {"

Replace with "TriggerServerEvent('gksphone:NewMail', {"

Also you will need to remove the lb-phone Dependencie from the fxmanifest
